...
class Contato(Base):
    ...
    nivel_influencia: Mapped[str] = mapped_column(String(20), nullable=False, default="sem_info", server_default="sem_info")
    papel_decisao: Mapped[str | None] = mapped_column(Text)
    email: Mapped[str | None] = mapped_column(String(255))
    telefone_whatsapp: Mapped[str | None] = mapped_column(String(20))
